  ...
  return (
    <div className="w-full bg-brand-blue text-white py-2 px-2 md:px-6 shadow-sm relative z-50">
      <div className="max-w-7xl mx-auto flex flex-wrap justify-center md:justify-end gap-3 md:gap-6 text-xs md:text-sm font-semibold tracking-wide">
        <a href="#login" className="hover:text-brand-cream transition-colors cursor-pointer text-center whitespace-nowrap">Entrar (Login)</a>
        <a href="#cadastro" className="hover:text-brand-cream transition-colors cursor-pointer text-center whitespace-nowrap">Cadastre-se</a>
